...
public class CSVUtils {
	...
	public static void writeFirstLine(Writer w) throws IOException {
		CSVUtils.writeLine(w, Arrays.asList("user_name", "user_email", "title", "description", "date", "category",
				"location", "price", "address", "phone", "website", "image_1", "image_2", "image_3", "image_4"));
	}
	...
	public static void writeAnnonce(Writer w, Annonce annonce) {
		...
		try {
			...
			writeLine(w, Arrays.asList("import-annonces.nc", "import@annonces.nc", annonce.titre, texteTrunc,
					reportDate, annonce.category, "", annonce.prix, "", "", annonce.url, img1, img2, img3, img4));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
